...
void gen1(int n, double* a, double* d, double* c, double* x, double *F, double *K, double *G); // method1 
void gen2(int n, double* a, double* d, double* c, double* u, double* x, double *F, double *K, double *G); // metod2
